...
open class KWStepper: UIControl {
    ...
    */
    ...
    open var decrementStepValue = 1.0 {
        willSet {
    ...
    open var incrementStepValue = 1.0 {
        willSet {
    ...
    open weak var delegate: KWStepperDelegate?
    ...
    open let decrementButton: UIButton

    /// A `UIButton` that increments `value` when pressed.
    open let incrementButton: UIButton
